...
import type { SbpmOriginType, SbpmItemNamespaceType, SbpmItemType } from './types';
...
export function createJointType(namespace: SbpmItemNamespaceType, type: SbpmOriginType | SbpmItemType) {
