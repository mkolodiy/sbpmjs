...
import { CustomEvent, FONT_FAMILY } from "../common/constants";
import { autoRenewIcon, deleteIcon } from "../common/icons";
import type { SbpmSendStateTransition as SbpmSendStateTransitionOptions } from "../common/types";
